...
EMSCRIPTEN_BINDINGS(spine) {
    ...
    class_<RegionAttachment, base<Attachment>>("RegionAttachment")
        ...
        .function("computeWorldVertices", select_overload<void(Bone &, Vector<float> &, size_t, size_t)>(&RegionAttachment::computeWorldVertices), allow_raw_pointer<SPVectorFloat>())
