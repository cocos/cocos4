        ...
        const dump = {
            ...
            userData: {
                oneOf: {
                    ...
                    switchType: 'String',
                    variants: [
                        { branch: 'dog', label: 'Dog', creatable: true },
                        { branch: 'cat', label: 'Cat', creatable: true },
                        { branch: 'number', label: 'Number', creatable: true },
                    ],
                },
            },
        };
        ...
        const dump = {
            ...
            userData: {
                oneOf: {
                    ...
                    variants: [
                        { branch: 'number', label: 'Number', creatable: true },
                        { branch: 'string', label: 'String', creatable: true },
                        { branch: 'boolean', label: 'Boolean', creatable: true },
                    ],
                },
            },
        };
